	...
	If @Output > '' 
		Begin
			Set @Output = Char(13) + Char(10) 
						  + 'Page life expectancy is the number of seconds a page will stay in the buffer pool, ideally it should be above 300 seconds.'
						  + ' If it is less than 300 seconds this could indicate memory pressure, a cache flush or missing indexes.'
						  + Char(13) + Char(10) 
						  + Char(13) + Char(10) 
						  + @Output
