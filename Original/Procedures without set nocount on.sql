	...
	If @Output > '' 
		Begin
			Set @Output = Char(13) + Char(10) 
						  + 'When you have a lot of updates and inserts or deletes in a stored procedure it is good to set nocount to on.'
						  + Char(13) + Char(10) 
						  + 'SQL server can become really chatty when this setting is off; this will waste bandwith and CPU power.'
						  + Char(13) + Char(10) 
						  + 'If a proc is called 30 times a second and you do 3 DML operations then that will result in '
						  + Char(13) + Char(10) 
						  + '90 n row(s) affected messages'
						  + Char(13) + Char(10) 
						  + Char(13) + Char(10) 
						  + @Output
