...
--	If you require a comprehensive list of Invalid Objects you can use the SQL Prompt find invalid objects functionality: https://documentation.red-gate.com/sp/sql-refactoring/refactoring-an-object-or-batch/finding-invalid-objects

--	Written by Chris Unwin 17/09/2019

ALTER PROCEDURE [SQLCop].[test Invalid Objects]
AS
BEGIN
